...
public class IndexableListViewActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        items.add("Memoir '44");
        items.add("Memoir '44: Eastern Front");
        items.add("Memoir '44: Mediterranean Theater");
        items.add("Memoir '44: New Flight Plan");
        items.add("Memoir '44: Pacific Theater");
        items.add("Memoir '44: Terrain Pack");
        items.add("Memoir '44: Winter Wars");
        items.add("Memoir '44: Winter/Desert Board Map");
        ...
        items.add("The Quacks of Quedlinburg");
        items.add("The Quacks of Quedlinburg: The Herb Witches");
        items.add("The River");
