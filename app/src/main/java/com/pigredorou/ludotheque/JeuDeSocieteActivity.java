...
public class JeuDeSocieteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Todo - Creer une activité pour ajouter/modifier un jeu
        //Todo - Creer une activité pour visualiser un jeu en détail
        //Todo - Créer une activité pour parcourir les jeux
